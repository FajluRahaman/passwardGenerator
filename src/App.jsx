...
function App() {
  ...
  const copPasswardToClipboard = useCallback(() => {
  ...
  return (
   ...
   <h1 className='text-white text-center my-3'> Passward Generator</h1>
    <div className= "flex shadow rounded-lg overflow-hidden mb-4">
      <input type="text" value = {passward} className='outline-none w-full py-2 px-3 bg-white' placeholder ='passward' readOnly 
      ref={passRef} />

      <button onClick={copPasswardToClipboard} className=' bg-blue-700 text-white
